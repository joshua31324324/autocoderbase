  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      <main className="max-w-2xl w-full space-y-8 py-20">
        ...
        <a href="https://unemployment-visualization-gih01tf2q.vercel.app/">Unemployment</a>
        <p className="text-lg text-medium-contrast text-center">
          This site shows a slideshow showing the rates of unemployment in America.</p>
        ...
        <a href="https://weekdays-nine.vercel.app/">Weekdays</a>
